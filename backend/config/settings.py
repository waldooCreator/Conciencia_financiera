...
# In development, allow all hosts for easy mobile testing
if DEBUG:
    ALLOWED_HOSTS = ['*']
...
if DEBUG:
    ...
    CORS_ALLOWED_ORIGINS = os.environ.get('CORS_ALLOWED_ORIGINS', 'http://localhost:3000,http://localhost:8081,http://localhost:19006').split(',')
